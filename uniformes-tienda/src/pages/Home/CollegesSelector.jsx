              ...
              {(() => {
                ...
                return filtered.map((col, i) => {
                  ...
                  <button key={col.id} className="cs-card"
                    onClick={disabled ? undefined : ()=>onSelect(col)}
                    onMouseEnter={disabled ? undefined : ()=>setHovered(col.id)}
                    onMouseLeave={disabled ? undefined : ()=>setHovered(null)}
                    style={{ animationDelay:`${i*80}ms`, opacity: disabled ? 0.55 : 1, cursor: disabled ? "default" : "pointer" }}>
